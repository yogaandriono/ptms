	...
	<div class="card-body">
        ...
        <div class="container-fluid">
			<div class="row">
				...
				<!-- <img src="http://localhost/ptms/uploads/rrsaja.png" class="img-circle" id="sys_logo" alt="System Logo"> -->
				</div>
				<div class="col-8">
			...
			<table class="table table-bordered table-hover table-striped">
				...
				<thead>
					<tr class="bg-gradient-primary text-light">
						...
						<th><center>Total Time Rendered</center></th>
						<th><center>Total Employees</center></th>
