...
<body class="hold-transition ">
  ...
  <style>
    ...
    body{
      background-image: url("http://localhost/ptms/uploads/bgRR.png");
  ...
  <div class="h-100 d-flex align-items-center w-100" id="login">
    <div class="col-7 h-100 d-flex align-items-center justify-content-center">
      <div class="w-100">
        ...
        <center><img src="http://localhost/ptms/uploads/logoRR.png" alt="" id="logo-img"></center>
        <h1 class="text-center"><b><?php echo $_settings->info('name') ?> <br>Admin</b></h1>
      </div>
      ...
      <div class="d-flex w-100 h-100 justify-content-center align-items-center">
        <div class="card col-sm-12 col-md-6 col-lg-3 card-outline card-primary rounded-0 shadow">
          <div class="card-header rounded-0">
            ...
            <!-- <a href="<?php echo base_url ?>"><center>Go to Employee-Side</center></a> -->
          </div>
